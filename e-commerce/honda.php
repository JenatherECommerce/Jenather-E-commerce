...
$sql_honda_hatchback = "SELECT p.*, pd.engine_performances, pd.dimensions, pd.interior_comfort, pd.safety, pd.wheel, pd.features 
                   FROM products p 
                   JOIN products_description pd ON p.products_description_id = pd.products_description_id 
                   WHERE p.product_brand = 'Honda' AND p.body_config = 'Hatchbacks'";
$sql_honda_suv = "SELECT p.*, pd.engine_performances, pd.dimensions, pd.interior_comfort, pd.safety, pd.wheel, pd.features 
                   FROM products p 
                   JOIN products_description pd ON p.products_description_id = pd.products_description_id 
                   WHERE p.product_brand = 'Honda' AND p.body_config = 'SUVS'";
$sql_honda_sedans = "SELECT p.*, pd.engine_performances, pd.dimensions, pd.interior_comfort, pd.safety, pd.wheel, pd.features 
                   FROM products p 
                   JOIN products_description pd ON p.products_description_id = pd.products_description_id 
                   WHERE p.product_brand = 'Honda' AND p.body_config = 'Sedans and coupes'";
$sql_honda_mini_truck = "SELECT p.*, pd.engine_performances, pd.dimensions, pd.interior_comfort, pd.safety, pd.wheel, pd.features 
                   FROM products p 
                   JOIN products_description pd ON p.products_description_id = pd.products_description_id 
                   WHERE p.product_brand = 'Honda' AND p.body_config = 'Minivans and Trucks'";


$honda_product1 = $conn->query($sql_honda_hatchback);
$honda_product2 = $conn->query($sql_honda_suv);
$honda_product3 = $conn->query($sql_honda_sedans);
$honda_product4 = $conn->query($sql_honda_mini_truck);
...
<body>
    ...
    <section class="hatchbacks">
        <?php if(mysqli_num_rows($honda_product1) > 0): ?>
        <h1 id="hatchback">H A T C H B A C K S</h1>
        <div class="card-container">
                <?php
                    while($row = mysqli_fetch_assoc($honda_product1)){
                    ...
                    <div class="card-content">
                        ...
                        <div class="process-btn">
                            ...
                            <?php else: ?>
                                ...
                                <?php else: ?>
                                    <form action="honda-purchase.php" method="POST">
    ...
    <section class="sedan">
        ...
        <div class="card-container">
                <?php
                    while($row = mysqli_fetch_assoc($honda_product3)){
                        $isOutOfStock = $row['product_quantity'] <= 0;
                ?>
                <div class="card" data-product-id="<?php echo $row['product_id'] ?>">
                    <img src="Products/<?php echo $row['product_img']?>" alt="">
    ...
    <section class="suv">
        ...
        <div class="card-container">
                <?php
                    while($row = mysqli_fetch_assoc($honda_product2)){
                        $isOutOfStock = $row['product_quantity'] <= 0;
                ?>
                <div class="card" data-product-id="<?php echo $row['product_id'] ?>">
                    <img src="Products/<?php echo $row['product_img']?>" alt="">
    ...
    <section class="mpv">
        ...
        <div class="card-container">
                <?php
                    while($row = mysqli_fetch_assoc($honda_product4)){
                        $isOutOfStock = $row['product_quantity'] <= 0;
                ?>
                <div class="card" data-product-id="<?php echo $row['product_id'] ?>">
                    <img src="Products/<?php echo $row['product_img']?>" alt="">
